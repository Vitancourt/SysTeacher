    ...
    <section class="content">
        <div class="row">
            ...
            <div class="box">
                ...
                <h3 class="box-title">Feed de questões</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                <div class="col-md-12">
                    <form method="post" action="/homepage" name="form-filtro">
                    <label>Filtros:</label>
                    <br>
...
$('#ciencia').change(function(e){
    ...
    if (ciencia == "") {
        ...
        $('#loading-disciplina').html("<option value=''>- Selecione uma ciência -</option>");	
        $.getJSON('/getdisciplinafiltrofeed/'+ciencia, function (dados){
            if (dados.length > 0){ 	
...
$('#select-disciplina').change(function(e){
    ...
    if (disciplina == "") {
        ...
        $('#loading-conteudo').html("<option value=''>- Selecione uma ciência -</option>");  		
        $.getJSON('/getconteudofiltrofeed/'+disciplina, function (dados){
            if (dados.length > 0){ 	
